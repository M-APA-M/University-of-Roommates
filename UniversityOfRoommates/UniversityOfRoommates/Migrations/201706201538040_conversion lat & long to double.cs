namespace UniversityOfRoommates.Migrations
{
    ...
    public partial class conversionlatlongtodouble : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Affittoes", "longitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Affittoes", "latitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Stanzas", "longitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Stanzas", "latitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Casas", "longitudine", c => c.Double(nullable: false));
            AlterColumn("dbo.Casas", "latitudine", c => c.Double(nullable: false));
            AlterColumn("dbo.FotoCasas", "longitude", c => c.Double(nullable: false));
            AlterColumn("dbo.FotoCasas", "latitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Eventoes", "longitude", c => c.Double(nullable: false));
            AlterColumn("dbo.Eventoes", "latitude", c => c.Double(nullable: false));
            AlterColumn("dbo.GestioneCasas", "longitude", c => c.Double(nullable: false));
            AlterColumn("dbo.GestioneCasas", "latitude", c => c.Double(nullable: false));
            AddPrimaryKey("dbo.Affittoes", new[] { "idStanza", "nomeCasa", "longitude", "latitude", "UserId" });
